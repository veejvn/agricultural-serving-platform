...
import { CheckCircle2, FileText, Home, Printer, ShoppingBag } from "lucide-react"
    ...
    <div className="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl">
        <div className="mb-8 flex flex-col items-center justify-center text-center">
          ...
          <h1 className="text-3xl font-bold text-green-800 dark:text-green-300 sm:text-4xl">Đặt hàng thành công!</h1>
        ...
        <Card>
          <CardHeader>
            <div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
              <CardTitle className="text-xl text-green-800 dark:text-green-300">Đơn hàng #{orderNumber}</CardTitle>
          ...
          <CardContent className="space-y-6">
            <div className="rounded-lg bg-green-50 p-4 dark:bg-green-900/30">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-green-800 dark:text-green-300">Thông tin đơn hàng</span>
              </div>
              <div className="mt-3 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Mã đơn hàng</p>
                  <p className="font-medium">{orderNumber}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Ngày đặt hàng</p>
                  <p className="font-medium">{orderDate}</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Phương thức thanh toán</p>
                  <p className="font-medium">Thanh toán khi nhận hàng (COD)</p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Trạng thái</p>
                  <p className="font-medium text-orange-600 dark:text-orange-500">Đang xử lý</p>
                </div>
              </div>
            </div>

            <div>
              <h3 className="mb-3 font-medium text-green-800 dark:text-green-300">Thông tin giao hàng</h3>
              <div className="rounded-lg border p-4">
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div className="sm:col-span-2">
                    ...
                    <p className="font-medium">123 Đường Nông Nghiệp, Phường 1, Quận 1, TP. Hồ Chí Minh</p>
                  </div>
                  <div className="sm:col-span-2">
                    <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Ghi chú</p>
                    <p className="font-medium">Giao hàng trong giờ hành chính</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <h3 className="mb-3 font-medium text-green-800 dark:text-green-300">Sản phẩm đã đặt</h3>
