...
export default function CartPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 sm:px-6 lg:px-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-green-800 dark:text-green-300 sm:text-4xl">Giỏ Hàng</h1>
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div>
            <Card className="sticky top-20">
              <CardHeader>
                <CardTitle className="text-xl text-green-800 dark:text-green-300">Tóm tắt đơn hàng</CardTitle>
              </CardHeader>
