...
import { Users, ShoppingCart, Package, DollarSign, TrendingUp, UserCheck } from "lucide-react"
        ...
        <ChartCard
          ...
          chart={
            <div className="h-[300px] w-full bg-gray-100 dark:bg-gray-800 rounded-md flex items-center justify-center">
              ...
              <span className="ml-2 text-gray-500">Biểu đồ phân bố người dùng</span>
            </div>
          }
        />
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                { name: "Bắp cải Lâm Đồng", category: "Rau củ", price: "15,000 VNĐ", status: "Đã duyệt" },
                { name: "Cà rốt Đà Lạt", category: "Rau củ", price: "20,000 VNĐ", status: "Chờ duyệt" },
                { name: "Dừa Bến Tre", category: "Trái cây", price: "15,000 VNĐ", status: "Đã duyệt" },
                { name: "Chuối Nam Mỹ", category: "Trái cây", price: "25,000 VNĐ", status: "Chờ duyệt" },
                { name: "Xoài cát Hòa Lộc", category: "Trái cây", price: "90,000 VNĐ", status: "Đã duyệt" },
              ].map((product, index) => (
